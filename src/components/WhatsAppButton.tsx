...
const variants: Record<Variant, string> = {
  ...
  fab: 'fixed z-40 bottom-24 start-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe57] md:bottom-6 md:start-6 md:hidden',
}

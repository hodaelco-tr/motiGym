...
const variants: Record<Variant, string> = {
  ...
  secondary:
    'bg-ink text-white hover:bg-ink-soft px-6 min-h-12',
  ghost:
  ...
  fab: 'fixed z-40 bottom-24 start-4 md:bottom-6 md:start-6 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe57] md:hidden',
}

/**
 * Plain <a href> only — no JS, no target=_blank.
 * This is how WhatsApp / most landing pages implement click-to-chat.
 */
export function WhatsAppButton({
  ...
  return (
    <a
      href={getWhatsAppUrl()}
      aria-label="פתח צ'אט WhatsApp עם מרדכי"
